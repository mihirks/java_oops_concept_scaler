...
public abstract class Book implements Lendable{
    ...
    public boolean lend(User user) {
        if(!user.canBorrowBooks()){
            ...
            System.out.println("oops.Book is already borrowed by someone else.");
        }
        return false;
    }
    ...
    public void returnBook(User user) {
        if(!isAvailable && owner == user){
            ...
            System.out.println("oops.Book is already available , not returning possible");
        }
        else {
            System.out.println("oops.Book is not given to this oops.User " + user.getName());
        }
